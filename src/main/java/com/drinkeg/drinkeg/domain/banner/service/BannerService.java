...
public interface BannerService {
    ...
    // 배너 생성 및 저장
    Long saveBanner(MultipartFile bannerImage, BannerRequest bannerRequest);

    // 단일 배너 조회
    BannerResponse showBanner(Long bannerId);

    // 전체 배너 조회
    AllBannerResponse showAllBanner();

    // 배너 업데이트
    void updateBanner(Long bannerId, MultipartFile bannerImage, BannerRequest bannerRequest);
