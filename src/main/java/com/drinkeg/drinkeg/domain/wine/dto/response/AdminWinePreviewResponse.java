...
public class AdminWinePreviewResponse {
    ...
    @Builder
    public AdminWinePreviewResponse(Long wineId, String name, String nameEng, String sort, String variety, String country, String region, LocalDateTime createdAt) {
        this.wineId = wineId;
        this.name = name;
