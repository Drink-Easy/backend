...
public class TastingNoteUpdateRequest {
    ...
    @Builder
    public TastingNoteUpdateRequest(String color, LocalDate tastingDate, Integer sweetness, Integer acidity, Integer tannin, Integer body, Integer alcohol, List<String> updateNoseList, Float rating, String review) {
        this.color = color;
