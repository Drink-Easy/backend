...
public class TastingNoteRequestDTO {
    ...
    @Min(value = 0, message = "만족도는 0.0 이상 5.0 이하의 실수 값이어야 합니다.")
    @Max(value = 5, message = "만족도는 0.0 이상 5.0 이하의 실수 값이어야 합니다.")
