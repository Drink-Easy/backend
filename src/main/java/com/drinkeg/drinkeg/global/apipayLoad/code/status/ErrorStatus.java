package com.drinkeg.drinkeg.global.apipayLoad.code.status;
...
public enum ErrorStatus implements BaseCode {
    ...
    NOT_YOUR_PARTY(HttpStatus.FORBIDDEN, "PARTY4003", "모임 개설자가 아닙니다."),
    ...
    WINE_CLASS_BOOKMARK_ALREADY_EXISTS(HttpStatus.BAD_REQUEST, "WINE_CLASS_BOOKMARK4002", "이미 존재하는 북마크입니다."),
    ...
    PROFILE_IMAGE_NOT_FOUND(HttpStatus.BAD_REQUEST, "MEMBER4014", "삭제할 프로필 이미지가 없습니다"),
